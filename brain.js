...
🎯 𝚒𝚖𝚊𝚐𝚎
`
arus.sendMessage(m.chat,{video:{url:"https://a.uguu.se/VpvferWA.mp4"},caption:hlp,gifPlayback:true},{quoted:m})
break
//////////////////////////GENERAL\\\\\\\\\\\\\\\\\\\\\\\\\\
  case'rank':
...
case 'yts': case 'ytsearch': {
    ...
    arus.sendMessage(m.chat, { image: { url: search.all[0].thumbnail },jpegThumbnail:fs.readFileSync('./lib/hisoka.jpg'),  caption: teks, }, { quoted: m, })
}
break
